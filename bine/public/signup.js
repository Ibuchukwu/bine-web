    ...
    if(section == 'faculty'){
        let pageContent= `
            <div style="font-size: 20px;">
                <h3 style="text-align: center;">Add a new Faculty</h3><hr>
                <label for="faculty-name"><b>Faculty Name:</b></label>
                <input type="text" id="faculty-name" name="faculty-name" required><br>
                <label for="faculty-ac"><b>Faculty Acronym (School Approved):</b></label>
                <input type="text" id="faculty-ac" name="faculty-ac" required><br>
                <div style="display: flex; padding: 5px">
                    <button id="add-faculty" style="width: 40%; margin: auto;" onclick="parseSection('faculty','faculty-name', 'faculty-ac')"> Add Faculty </button>
                    <button id="cancel" style="width: 40%; margin: auto;" onclick="runWindow('close','')"> Cancel </button>
                </div>
            </div>`;
        ...
        let pageContent= `
            <div style="font-size: 20px;">
                <h3 style="text-align: center;">Add a new Department</h3><hr>
                <label for="department-name"><b>Department Name:</b></label>
                <input type="text" id="department-name" name="department-name" required><br>
                <label for="department-ac"><b>Department Acronym (School Approved):</b></label>
                <input type="text" id="department-ac" name="department-ac" required><br>
                <div style="display: flex; padding: 5px">
                    <button id="add-department" style="width: 40%; margin: auto;" onclick="parseSection('department','department-name', 'department-ac')"> Add Department </button>
                    <button id="cancel" style="width: 40%; margin: auto;" onclick="runWindow('close','')"> Cancel </button>
                </div>
            </div>`;
        runWindow("open", pageContent);
