...
onAuthStateChanged(auth, async (User) => {
  if (User) {
    ...
    document.getElementById("className").textContent = userObj.class;
    document.getElementById("departmentName").textContent = userObj.department;
  } else {
    console.error("No user is signed in.");
    if(window.location.pathname != '/login' && window.location.pathname != '/signup' && window.location.pathname != '/portal' && window.location.pathname != '/create_profile'){
