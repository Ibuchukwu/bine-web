...
export function createPaymentModal(virtualAccount) {
  return `
...
export async function initiatePayment(totalAmount, regno, universityId, cart) {
  ...
  try {
    ...
    modalContainer.querySelector('.payment-modal').innerHTML = createPaymentModal(accountDetails);
...
export function startExpiryTimer(seconds) {
...
export function startPaymentPolling(payment) {
...
// Add to portalPay.js
export async function verifyPaymentManually(element) {
  try {
...
// portalPay.js
 export async function cancelCurrentPayment(element) {
  try {
    showLoad("show", element.id);
